const screen = {
    ...
    renderUser(user){
        ...
        user.repositories.forEach(repo => repositoriesItens += `<li><a href="${repo.html_url}" target="_blank">${repo.name} <div class="info-com-emogi">
                                <p>&#127860 ${repo.forks}</p>
                                <p>⭐ ${repo.stargazers_count}</p>
                                <p>&#128064 ${repo.watchers}</p>
                                <p>👨‍💻 ${repo.language}</p>
                            </div></a></li>`);
